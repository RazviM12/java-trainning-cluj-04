...
public class Main {
    ...
    public static void studioNameThatPublishedMoreThan2Movies(){
    ...
    public static void studioNameInWhichPlaysActorWithName(){
        for(Studio studio : getData())
    ...
    public static void getMovieNamesInWhichPlayesaActorWithAgeAbove50(){
        for(Studio studio : getData())
            for(Film film : studio.filme)
                for(Actor actor : film.actori)
    ...
    public static void main(String[] args){
        ...
        studioNameThatPublishedMoreThan2Movies();
        studioNameInWhichPlaysActorWithName();
        getMovieNamesInWhichPlayesaActorWithAgeAbove50();
